...
class Test_Slash_Command_Activity_Warnings(unittest.TestCase): 
    ...
    def test_enable_activity_warnings(self):
        ...
        # Make a mock POST request to /enable_activity_warnings
        output = requests.post("http://127.0.0.1:5000/enable_activity_warnings", 
        data=json.dumps(slash_cmd), headers={'Content-Type': 
        'application/json'})
        cmd_output = output.json()
